...
export const routesPage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'smartLink',
      group: 'finalCta',
      description: 'Primary editor control for WhatsApp. Smart link overrides legacy URL/label.',
    }),
    defineField({
      ...
      type: 'smartLink',
      group: 'finalCta',
      description: 'Primary editor control for the second button. Smart link overrides legacy URL/label.',
    }),
    defineField({
      name: 'finalCtaWhatsappHref',
      title: 'WhatsApp URL (legacy fallback)',
      type: 'string',
      group: 'finalCtaLegacy',
      description: 'Only used if WhatsApp smart link is empty.',
    }),
    defineField({
