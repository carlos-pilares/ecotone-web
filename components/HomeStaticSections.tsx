          ...
          <div className="manifesto-grid fade">
            ...
            <div>
              ...
              <div className="manifesto-cta">
                <a href={h.manifestoCta1Link ?? '#'} className="btn-primary">
                  {h.manifestoCta1Text ?? ''}
                </a>
                <a href={h.manifestoCta2Link ?? '#'} className="btn-outline">
                  {h.manifestoCta2Text ?? ''}
                </a>
              </div>
            </div>
          ...
          <div className="booking-layout">
            ...
            <div>
              <div className="book-card">
                ...
                <a href={h.bookingCta1Link ?? '#'} className="btn-book">
                  {h.bookingCta1Text ?? ''}
                </a>
                <a href={h.bookingCta2Link ?? '#'} className="btn-wa">
