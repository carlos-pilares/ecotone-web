      ...
      <div className="footer-inner">
        <div>
          <div className="foot-logo">
            <a href="/" className="nav-logo" aria-label="Ecotone home">
              <svg className="nav-logo-isotipo" viewBox="0 0 105 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="foot-tagline">People meet nature</div>
          <p
            style={{
              fontSize: 13,
              fontWeight: 300,
          ...
          >
            Immersive nature tourism
            <br />
            Cusco, Perú · Manu &amp; Camanti
          </p>
        </div>
        <div className="foot-col">
          ...
          <ul className="foot-links">
            ...
            <li>
              <a href="https://www.ecotone.eco/copy-of-programas">Routes</a>
            </li>
            <li>
              <a href="https://www.ecotone.eco/destinations">Lodges</a>
            </li>
            <li>
              <a href="https://www.ecotone.eco/services-4">Programs</a>
            </li>
            <li>
              <a href="https://www.ecotone.eco/blog">Journal</a>
            </li>
          </ul>
        </div>
        <div className="foot-col">
          ...
          <ul className="foot-links">
            <li>
              <a href="https://wa.me/51974781094">WhatsApp</a>
            </li>
            <li>
              <a href="https://www.ecotone.eco">ecotone.eco</a>
            </li>
            <li>
              <a href="https://www.instagram.com">Instagram</a>
            </li>
            <li>
              <a href="https://www.ecotone.eco">Privacy policy</a>
            </li>
          </ul>
        </div>
      </div>
      <div className="foot-bottom">
        <p className="foot-copy">© 2026 Ecotone · HERPIRO · All rights reserved.</p>
        <div className="foot-certs">
          <span className="foot-cert">B Corp</span>
          <span style={{ width: 1, height: 12, background: 'rgba(236,229,213,.15)' }} />
          <span className="foot-cert">ATTA Member</span>
          <span style={{ width: 1, height: 12, background: 'rgba(236,229,213,.15)' }} />
          <span className="foot-cert">GSTC</span>
        </div>
      </div>
    </footer>
  )
