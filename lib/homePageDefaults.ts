...
export const defaultHomePageDoc: ResolvedHomePage = {
  ...
  explorerCardImageFallbackUrl: t.explorerCardImageFallbackUrl,
  ...
  blogEmptyMessage: t.blogEmptyMessage,
  blogFallbackPostHref: t.blogFallbackPostHref,
  ...
  bookingPriceSuffixSmall: t.bookingPriceSuffixSmall,
